...
PACKAGES = ['compas', 'compas_rhino', 'compas_fofin', 'FormFinder']
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='compas_formfinder Installation command-line utility.')
    ...
    print("\n", "-"*10, "Installing compas_formfinder python plugin", "-"*10)
